<div>
    ...
    <div class="container py-12">
        ...
        <div class="mb-12">
            <div
                class="md:grid md:grid-cols-1 mb-12 px-4 py-5 sm:px-6 mt-5 md:mt-0 md:col-span-2 bg-white shadow overflow-hidden sm:rounded-lg">
                <h3 class="text-3xl leading-6 font-medium text-gray-900 text-center"><i class="fa fa-bullhorn"
                        aria-hidden="true" style="color: #0342cb"></i>
                    Usted pertenece a la agencia <span
                        class="capitalize">{{ strtolower(auth()->user()->ejecutivo->agencia->name) }}</span>
                </h3>
            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        <div class="text-center"><i class="fa fa-list fa-5x" style="color:#0342cb"
                ...
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        <div class="text-center"><i class="fa fa-thumbs-up fa-5x" style="color:#0342cb"
                                aria-hidden="true"></i></div>
                ...
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        <div class="text-center"><i class="fa fa-times fa-5x" style="color:#0342cb"
                                aria-hidden="true"></i></div>
